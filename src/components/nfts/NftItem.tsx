  ...
  return (
    <ItemCard className=' rounded-lg'>
      <div className='w-70 h-70 object-cover rounded-lg'>
        <img src={nft.imageUrl} width={150} height={150} alt="NFT" className="p-2 w-full h-40 object-cover rounded-lg" />
      </div>
      <p className="font-bold my-2 px-2 w-full text-center truncate hover:text-[#FF8A57]">{nft.name}</p>
    </ItemCard>
  )
};
